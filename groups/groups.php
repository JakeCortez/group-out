              ...
              <div class="tab-pane active" id="recent">
                ...
                <article class = "media">
                  ...
                  <div class = "media-body">
                    <h5 id = "groupName" class = "route-name"></h5>
                    <h6 id = "groupLocation" class = "route-location"><small>City Name, ST | created 09.04.2014</small></h6>
                    <h4 id = "groupDifficulty"></h4>
                    <h6 id = "groupMembers"></h6>
                  </div>
                </article>
                <hr>
                <article class = "media">
