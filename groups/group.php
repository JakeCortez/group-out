  ...
  <body>
    ...
    <div class = "container-fluid">
      ...
      <article class = "col-lg-10">
        <?php require_once('group-page-content.php');?>

      <div class="bar col-md-10">Comments</div>
      <div style="clear:both;"></div>

      <?php require_once('comment-list-create-groupid.php');?>

      <!-- comment entry form-->
      <div class="bar col-md-10">Add a comment</div>
      <div style="clear:both;"></div>
      <form class="form-horizontal" role="form" action="insert-group-comment.php" method="post">
          <input type="hidden" value="<?php echo $_GET['groupID'];?>" id="groupID" name="groupID" />
