...
///// STATIC METHOD to get public events by the userID of the event author
  ...
  public static function getEventsByUserID(&$mysqli, $userID) {
    ...
    while(($row = $result->fetch_assoc()) !== null) {
      $eventArray[] = new Event($row["eventID"], $row["routeID"], $row["userID"], $row["eventDate"], $row["eventCity"], $row["eventDateCreated"], $row["eventDescription"], $row["eventDifficulty"], $row["eventName"], $row["eventPrivacy"], $row["eventState"], $row["eventZip"], $row["eventMemberCount"], $row["eventActivityList"]);
    }
